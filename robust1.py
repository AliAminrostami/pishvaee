...
m.c_ip = pyo.Param(m.I,m.P,initialize=0.2)
m.c_jp = pyo.Param(m.J,m.P,initialize=0.2)
m.c_p = pyo.Param(m.P,initialize=0.2)  
m.c_i = pyo.Param(m.I,initialize=0.2)
