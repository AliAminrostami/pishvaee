...
m = pyo.ConcreteModel()
#%% RangeSet Definition
m.I = pyo.RangeSet(5)   #suppliers
m.J = pyo.RangeSet(5)  #buyer(hospitals)
m.P = pyo.RangeSet(5)   #product(medicine)
m.S = pyo.RangeSet(5)   #scenarios
#%% Read Data from excel file
d_jps_ = pd.read_excel(r"problem2.xlsx", sheet_name="d_jps",header=None)
as_ip_ = pd.read_excel(r"problem2.xlsx", sheet_name="As_ip",header=None)
as_hat_= 0.1*as_ip_
ar_jp_ = pd.read_excel(r"problem2.xlsx", sheet_name="Ar_jp",header=None)
ar_hat_= 0.1*ar_jp_
hr_jp_ = pd.read_excel(r"problem2.xlsx", sheet_name="hr_jp",header=None)
hr_hat_ = 0.1*hr_jp_
ff_p_ = pd.read_excel(r"problem2.xlsx", sheet_name="ff_p",header=None)
ff_hat_ = 0.1 * ff_p_
pp_s_ = pd.read_excel(r"problem2.xlsx", sheet_name="pp_s",header=None)
Ocu_1_is_= pd.read_excel(r"problem2.xlsx", sheet_name="ocu1",header=None)
Ocu_2_is_= pd.read_excel(r"problem2.xlsx", sheet_name="ocu2",header=None)
Ocu_3_is_= pd.read_excel(r"problem2.xlsx", sheet_name="ocu3",header=None)
Em_1_is_= pd.read_excel(r"problem2.xlsx", sheet_name="em1",header=None)
Em_2_is_= pd.read_excel(r"problem2.xlsx", sheet_name="em2",header=None)
Em_3_is_= pd.read_excel(r"problem2.xlsx", sheet_name="em3",header=None)
Eg_1_is_= pd.read_excel(r"problem2.xlsx", sheet_name="eg1",header=None)
Eg_2_is_= pd.read_excel(r"problem2.xlsx", sheet_name="eg2",header=None)
Eg_3_is_= pd.read_excel(r"problem2.xlsx", sheet_name="eg3",header=None)
#%% convert to dict
...
coefficient_of_mean_deviation =  z_alfa*a*sum(m.ps[s]*(m.va[s] + m.vb[s]) for s in m.S)
